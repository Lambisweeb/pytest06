from funtion import display_month
import pytest

@pytest.mark.display #pytest -m display
@pytest.mark.paramtrize('input_number','expected_result',[
    (1,"january"),(2,"february"),(3,"march"),(4,"april"),
    (5,"may"),(6,"june"),(7,"july"),(8,"august"),
    (9,"september"),(10,"october"),(11,"november"),(12,"december"),(0,"out of range"),
    (13,"out of range"),(-10,"out of range"),(22,"out of range"),
