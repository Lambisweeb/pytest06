from funtion import number_to_month, validate_number
import pytest

@pytest.mark.code #ใช้คำสั่ง pytest-m code
...
@pytest.mark.validate #ใช้คำสั่ง pytest -m validate 
...
@pytest.mark.validate #ใช้คำสั่ง pytest -m validate2 
def test_out_of_range_input_10p():
    input = -10
    expected_result = "out of range"
    actual_result = validate_number(input)
    assert expected_result == actual_result
...
@pytest.mark.validate #ใช้คำสั่ง pytest -m validate 
def test_out_of_range_input_1_1():
    input = 1.1
...
@pytest.mark.validate #ใช้คำสั่ง pytest -m validate
def test_out_of_range_input_aa():
    input = "#"
    expected_result = "input integer"
    actual_result = validate_number(input)
    assert expected_result == actual_result
...
@pytest.mark.validate #ใช้คำสั่ง pytest -m validate 
def test_out_of_range_input__1p5():
    input = -1.5
    expected_result = "out of range"
    actual_result = validate_number(input)
    assert expected_result == actual_result
